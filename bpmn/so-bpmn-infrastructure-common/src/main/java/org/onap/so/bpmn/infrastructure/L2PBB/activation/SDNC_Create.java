...
public class SDNC_Create implements JavaDelegate {


    private final static Logger log = Logger.getLogger(SDNC_Create.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
    	...
    	String Host1_DBMAC = execution.getVariable("Host1_DBMAC").toString();
    	String Host2_DBMAC = execution.getVariable("Host2_DBMAC").toString();
    	...
    	//json message for host1 configuration
    	...
    	//json message for host2 configuration        
