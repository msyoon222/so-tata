...
public class SDNC_Update implements JavaDelegate {

    private final static Logger log = Logger.getLogger(SDNC_Update.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
    	...
    	String CBS="";
    	try {
    		CBS = execution.getVariable("CBS").toString();
    	}catch(Exception e){
    	...
    	//host1 configuration update jsonpayload
    	...
    	//host2 configuration update jsonpayload
